...
with st.sidebar:
    ...
    st.markdown(
        ...
        <div style="background:#111C2E; border:1px solid #24344D; border-radius:6px; padding:12px; font-size:0.78rem; color:#94A3B8; line-height:1.45;">
            ...
            • Decision support for human commanders<br>
            • Non-destructive simulation sandbox<br>
            • Systemic cascade disruption ranking
        </div>
        """,
        unsafe_allow_html=True,
    )
...
with tab_reroute:
    ...
    if reroute_info:
        st.markdown(
            f"""
            <div style="background:#0F172A; border:1px solid #22C55E; border-radius:6px; padding:10px 14px; margin-bottom:10px; font-size:0.88rem;">
                <b style="color:#22C55E;">✅ Passable Detour Available:</b> Total distance <b>{reroute_info['total_distance_km']} km</b> across <b>{reroute_info['hop_count']} segments</b>.
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    st.markdown(
        ...
        <div class="metric-card-box">
            ...
            <div style="font-size:0.82rem; color:#CBD5E1; line-height:1.45; margin-top:6px;">
                • <b>Human Decision-Maker:</b> System acts as an advisory intelligence tool for emergency commanders.<br>
                • <b>Real Geospatial Feeds:</b> Stage 2 integrates <b>Sentinel-1 SAR</b> (flood water masks), <b>Copernicus DEM</b> (terrain), <b>OpenStreetMap</b> (road network), and <b>WorldPop</b> (spatial population).<br>
                • <b>ML Road Failure Classifier:</b> Predicts probabilistic failure states P(Failure | X) from hydrological and environmental covariates.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
